...
- **Persistent Quick Menu**: Interactive bottom keyboard buttons (Active Session, Resume / Session, New Session, Workspace, System & Usage, Help).
...
- **Antigravity CLI** (`agy`) Integration & Stream Runner
